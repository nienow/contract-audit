contract ElevenGrowthVault is ERC20, Ownable {
    ...
    bool public firstTimeStrategy = true;
    ...
    constructor (
        ...
        string("11 Wswap LTC-BUSD"),
        string("11LTCBUSD")
    ) {
        token = IERC20(0x1209067dC48B3E15B25126EC785EC6CE492E997d);
    }
    ...
    function setStrategy(address _strat) public onlyOwner{
        require(firstTimeStrategy, "already initialized");
